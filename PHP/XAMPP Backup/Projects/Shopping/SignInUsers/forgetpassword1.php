...
?>
									<label class="control-label">Password is:<?php echo $pass; ?></label>
									<div class="controls">
                                                    <label class="control-label"></label>
                                								...
                                								<div class="control-group">
									<input name="num1" tabindex="3" class="btn btn-inverse large" type="submit" value="You Should Change Password!!">
									<hr>
                                   	</div>
							</fieldset>
						</form>				
