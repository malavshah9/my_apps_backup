<?php
session_start();
require '../Shared/Classes/classadmin.php'
?>
...
$conn=new admin_all;
$result=$conn->selectbyid($adminid);
    ...
    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          <div class="sidenav-header-inner text-center"><img src="<?php echo $row["img"]; ?>" alt="person" class="img-fluid rounded-circle">
            <h2 class="h5 text-uppercase"><?php echo $row["adminname"]; ?></h2><span class="text-uppercase"></span>
          </div>
          ...
          <ul id="side-admin-menu" class="side-menu list-unstyled"> 
            <li> <a href="#pages-nav-list" data-toggle="collapse" aria-expanded="false"><i class="icon-interface-windows"></i><span>Dropdown</span>
              ...
              <ul id="pages-nav-list" class="collapse list-unstyled">
                ...
                <li> <a href="tabusr.php">User Table</a></a></a></li>
                <li> <a href="tabadmin.html">Admin Table</a></li>
              </ul>
            </li>
            <li> <a href="proinsert.php"> <i class="icon-screen"> </i><span>Insert New Product</span></a></li>
