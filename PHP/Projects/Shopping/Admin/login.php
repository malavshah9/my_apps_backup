      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            <div class="logo text-uppercase"><span>Admin   </span><strong class="text-primary">    Log In</strong></div>
             <?php
              if(isset($_POST["sub1"]))
              {
                $u1=$_POST["loginUsername"];
                $p1=$_POST["loginPassword"];
               $cnn=new admin_all;
...
{echo "Kindly Check Your Username and Password";}
           ...
           ?>
            <form id="login-form" method="post" action="login.php">
              ...
              </div><input name="sub1" type="submit" id="login" value="LogIn " class="btn btn-primary">
