			...
			<section class="main-content">				
				<div class="row">
					<div class="span5">					
						...
						<form action="usr1.php" method="post">
							<input type="hidden" name="next" value="/">
							<fieldset>
								<div class="control-group">
									<label class="control-label">Username</label>
									<div class="controls">
										<input type="text" placeholder="Enter your username" id="username" class="input-xlarge" name="username1">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Username</label>
									<div class="controls">
										<input type="password" placeholder="Enter your password" id="password" class="input-xlarge" name="password1">
										</div>
								</div>
								<?php
									if(isset($_POST["num1"]))
...
$q='select * from usr where usr_id="'. $u1 .'"'.' and password="'. $p1 .'"';
$result=$conn->query($q);
...
else
{
	echo "Not Successfully";
					...
					<div class="span7">					
						...
						<form action="usrpro.php" method="post" class="form-stacked">
							<fieldset>
								<div class="control-group">
									<label class="control-label">Username</label>
									<div class="controls">
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="number" placeholder="Enter your Mobile No" class="input-xlarge">
									</div>
								</div>
                                <div class="control-group">
									<label class="control-label">Address:</label>
									<div class="controls">
										<textarea placeholder="Enter your Address" class="input-xlarge">
                                            </textarea>
									</div>
								</div>					
                                <div class="control-group">
									...
									<div class="controls">
										<input type="password" placeholder="Enter your Image" class="input-xlarge">
									</div>
								</div>
                                <div class="control-group">
